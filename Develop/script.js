...
function generatePassword() {
  ...
  if (hasNumbers) {
    alert("Your password will contatin numeric characters.");
  }
  else {
    alert("Your password will NOT contain numeric charactrers.");
  }
  ...
  if (hasLowercase === false && hasUppercase === false && hasNumbers === false && hasSpecial === false) {
    return "Please select at lease one characer typer.";
  };
